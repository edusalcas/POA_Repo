...
public class SellerAgent extends POAAgent {
	...
	/*
	 * Funcion encargada de a帽adir un paquete mediante la GUI
	 */
	...
	/*
	 * Clase encargada de la comunicaci贸n con el RB, para recibir las mercancias que
	 * este le entregue
	 */
	private class SuministroMercanciaResponder extends AchieveREResponder {
		...
		// Funci贸n encargada de manejar la llegada de un REQUEST
		@Override
		protected ACLMessage handleRequest(ACLMessage request) throws NotUnderstoodException, RefuseException {
			...
			try {
				...
				getLogger().info("Suministro Mercancia", "A馻didos los lotes: " + mercancia);
