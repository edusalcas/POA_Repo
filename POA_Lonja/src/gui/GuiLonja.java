...
public class GuiLonja extends JFrame {
	
	private SellerAgent myAgent;

	private JTextField titleField, cantidadField;

	public GuiLonja(SellerAgent sellerAgent) {
		...
		addButton.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				try {
					...
					JOptionPane.showMessageDialog(GuiLonja.this, "Invalid values. "+e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE); 
				}
			}
		} );
		p = new JPanel();
