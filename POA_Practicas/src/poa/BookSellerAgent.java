...
public class BookSellerAgent extends Agent {
	...
	// The catalogue of books for sale (maps the titple of a book to its price)
	...
	// This is invoked by the GUI when the user adds a neew book for sale
	public void updateCatalogue(final String title, final int price) {
		addBehaviour(new OneShotBehaviour() {
			...
			public void action() {
				...
				System.out.println(title + " inserted into catalogue with price = " + price);
			}
		});
	}
	...
	// End of inner class PurcharseOrderServer
